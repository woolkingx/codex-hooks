...
const KEBAB = 'user-prompt-submit'
const OUTPUT_ACTIONS = Object.freeze(["allow","deny","block","context","stop"])
const FULL_ACCESS_MESSAGE = 'User action required: switch Codex to full access mode (permission_mode=bypassPermissions). Then codex-hooks can run prompt rules locally.'

export const meta = Object.freeze({
  id: KEBAB,
  wire_name: 'UserPromptSubmit',
  input_schema: 'schema/api/openai-codex/generated/user-prompt-submit.command.input.schema.json',
  output_schema: 'schema/api/openai-codex/generated/user-prompt-submit.command.output.schema.json',
