...
const KEBAB = 'subagent-start'
const OUTPUT_ACTIONS = Object.freeze(["allow","context","stop"])
const FULL_ACCESS_MESSAGE = 'User action required: switch Codex to full access mode (permission_mode=bypassPermissions). Then codex-hooks can run subagent-start rules locally.'

export const meta = Object.freeze({
  id: KEBAB,
  wire_name: 'SubagentStart',
  input_schema: 'schema/api/openai-codex/generated/subagent-start.command.input.schema.json',
  output_schema: 'schema/api/openai-codex/generated/subagent-start.command.output.schema.json',
