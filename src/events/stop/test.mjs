...
test('trigger rule emits PDU', async () => {
  const input = {"hook_event_name":"Stop","session_id":"sess1","cwd":"/tmp","model":"gpt4","permission_mode":"bypassPermissions","last_assistant_message":null,"stop_hook_active":false,"transcript_path":"/tmp/t.txt","turn_id":"turn1"}
  const rules = [{
    id: 'const-rule',
    event: 'stop',
    priority: 100,
...
test('default permission mode blocks before rule evaluation', async () => {
  const input = {"hook_event_name":"Stop","session_id":"sess1","cwd":"/tmp","model":"gpt4","permission_mode":"default","last_assistant_message":null,"stop_hook_active":false,"transcript_path":"/tmp/t.txt","turn_id":"turn1"}
