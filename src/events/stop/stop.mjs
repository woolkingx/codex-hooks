...
const FULL_ACCESS_MESSAGE = 'User action required: switch Codex to full access mode (permission_mode=bypassPermissions). Then codex-hooks can run stop rules locally.'

export const meta = Object.freeze({
  id: KEBAB,
  wire_name: 'Stop',
  input_schema: 'schema/api/openai-codex/generated/stop.command.input.schema.json',
  output_schema: 'schema/api/openai-codex/generated/stop.command.output.schema.json',
