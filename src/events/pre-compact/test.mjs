...
import { handle } from './pre-compact.mjs'
...
test('trigger rule emits PDU', async () => {
  const input = {"hook_event_name":"PreCompact","session_id":"sess1","cwd":"/tmp","model":"gpt4","transcript_path":"/tmp/t.txt","trigger":"manual","turn_id":"turn1"}
  const rules = [{
    id: 'const-rule',
    event: 'pre-compact',
    priority: 100,
