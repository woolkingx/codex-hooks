...
export const meta = Object.freeze({
  ...
  input_schema: 'schema/api/openai-codex/generated/post-compact.command.input.schema.json',
  output_schema: 'schema/api/openai-codex/generated/post-compact.command.output.schema.json',
