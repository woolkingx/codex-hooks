...
const KEBAB = 'post-tool-use'
const OUTPUT_ACTIONS = Object.freeze(["allow","deny","block","context","update_mcp_tool_output","stop"])
const FULL_ACCESS_MESSAGE = 'User action required: switch Codex to full access mode (permission_mode=bypassPermissions). Then codex-hooks can run post-tool rules locally.'

export const meta = Object.freeze({
  id: KEBAB,
  wire_name: 'PostToolUse',
  input_schema: 'schema/api/openai-codex/generated/post-tool-use.command.input.schema.json',
  output_schema: 'schema/api/openai-codex/generated/post-tool-use.command.output.schema.json',
